...
| AF03 | `keyword` | nullable / string / max:255 |
| AF03 | `gender` | nullable / integer / in:0,1,2,3 |
| AF03 | `category_id` | nullable / integer / `exists:categories,id` |
| AF03 | `date` | nullable / date |
